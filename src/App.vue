<template>
  <div class="min-h-screen relative flex items-center justify-center">
    ...
    <div
      class="flex flex-col md:flex-row md:space-x-10 z-10 items-center space-y-4 px-2 md:px-0">
      <img
        src="./assets/design-it-logo.svg"
        class="-mt-20 md:mt-0 w-[160px] md:w-[250px] logo" />
...
const fadeOut = () => {
  ...
  timeline.fromTo(
    ...
    { filter: 'brightness(0.6)', duration: 0.5, ease: 'power1.out' },
    '<0.5'
  )
  ...
  timeline.fromTo(
    '.title',
    { opacity: 0, x: '100%' },
    { opacity: 1, x: 0, ease: 'elastic.out(0.8, 0.3)', duration: 2 },
    '<0.5'
  )
